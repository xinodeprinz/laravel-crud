    ...
    @csrf
      <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('title') }}" placeholder="Product title" name="title" class="form-control @error('title')
                            is-invalid
                        @enderror">
                        @error('title')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" value="{{ old('price') }}" placeholder="Product price" name="price" class="form-control @error('price')
                            is-invalid
                        @enderror">
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
               ...
               <div class="mb-3">
                ...
                <textarea name="description" value="{{ old('description') }}" class="form-control @error('description')
                    is-invalid
        ...
        <div class="col-md-3 mt-0 mt-md-4">
            <img src="/storage/images/empty.png" id="photo-img" alt="" class="img-fluid product-profile">
